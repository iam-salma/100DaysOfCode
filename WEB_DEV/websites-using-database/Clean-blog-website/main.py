...
'''
my_email = "salmasyed1360@gmail.com"
...
# post_objects = []
# for post in posts:
#     post_obj = Post(post["id"], post["title"], post["subtitle"], post["body"], post["img_url"])
...
def show_post(post_id):
    # post_objects = db.session.execute(db.select(Post).where(Post.id == post_id)).scalar()
    # requested_post = None
